                            ...
                            <div className="card-text">
                                <form onSubmit={(e)=>createUser(e)}>
                                    <div className="form-group">
                                        ...
                                        <input type="email" className="form-control form-control-sm" id="exampleInputEmail" onChange={(e)=>verifyEmail(e)}  placeholder="Enter Email"/>
                                        <span className="text-danger">{emailError}</span>
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="exampleInputName">User Name </label>  
                                        <input type="name" className="form-control form-control-sm" id="exampleInputName" onChange={(e)=>verifyName(e)} placeholder="Enter Name"/>
                                        <span className="text-danger">{nameError}</span>
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="exampleInputPassword">Password </label>  
                                        <input type="password" className="form-control form-control-sm" id="exampleInputPassword" onChange={(e)=>verifyPassword(e)} placeholder="Enter Password"/>
