  ...
  return (
    <Fragment>
      ...
      <div className="photo-gallery">
        <img src="./images/about1.jpg" alt="galleryImage1" />
        <img src="./images/about2.jpg" alt="galleryImage1" />
        <img src="./images/about3.jpg" alt="galleryImage1" />
        <img src="./images/about4.jpg" alt="galleryImage1" />        
      </div>
